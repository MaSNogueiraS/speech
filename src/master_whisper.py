...
from hera_speech.srv import RecordRequest  # Here the package name is 'hera_speech' and the service name is 'RecordRequest'
from hera_speech.srv import Transcribe, TranscribeResponse
