...
from hera_speech.srv import QuestionAnswer, QuestionAnswerRequest, QuestionAnswerResponse
#Author: MatS
...
class AnswerFromWhisper(object):
    ...
    def answer(self, req):
        ...
        openai.api_key = "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"
